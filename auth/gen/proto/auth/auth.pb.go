...
const file_proto_auth_auth_proto_rawDesc = "" +
	...
	"\n" +
	"expires_in\x18\x03 \x01(\x05R\texpiresIn\"5\n" +
	"\x0eRefreshRequest\x12#\n" +
	"\rrefresh_token\x18\x01 \x01(\tR\frefreshToken2n\n" +
	"\x04Auth\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x124\n" +
	"\aRefresh\x12\x14.auth.RefreshRequest\x1a\x13.auth.LoginResponseB1Z/gihub.com/rozoomcool/sihkaromicro/auth/gen/authb\x06proto3"
...
var file_proto_auth_auth_proto_depIdxs = []int32{
	...
	1, // 3: auth.Auth.Refresh:output_type -> auth.LoginResponse
